...
export function GenderDistributionCard({ data, loading }: GenderDistributionCardProps) {
    ...
    <Card className="p-5 h-full overflow-visible" id="chart-gender-dist">
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 mt-3 text-xs text-text-muted">
